        ...
        <div className="relative bg-[#131313]">
          ...
          >
            <div className="container mx-auto px-4 md:px-16 lg:px-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div className="transform transition-all duration-1000" style={{ transitionDelay: '500ms' }}>
                  {/* Project Card 1 */}
                ...
                <div className="transform transition-all duration-1000" style={{ transitionDelay: '600ms' }}>
                  {/* Project Card 2 */}
                  <div className="group bg-[#1A1A1A] rounded-xl overflow-hidden hover:bg-yellow-400/5 transition-all duration-300">
                    <div className="relative aspect-video overflow-hidden">
                      <img 
                ...
                <div className="transform transition-all duration-1000" style={{ transitionDelay: '700ms' }}>
                  {/* Project Card 3 */}
                  <div className="group bg-[#1A1A1A] rounded-xl overflow-hidden hover:bg-yellow-400/5 transition-all duration-300">
                    <div className="relative aspect-video overflow-hidden">
                      <img 
          ...
          >
            <div className="container mx-auto px-4 md:px-16 lg:px-24">
              ...
              <div className="max-w-3xl mx-auto bg-[#1A1A1A] rounded-2xl p-8 md:p-12 transform transition-all duration-1000">
