    ...
    <ParallaxProvider>
      ...
      <main className="relative">
        ...
        <section id="home" className="min-h-screen">
          <div className="relative w-full px-8 md:px-16 min-h-screen flex items-start pt-64 justify-center">
            <div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
              <Parallax translateY={[-20, 20]} opacity={[0.8, 1]}>
                <h1 className="text-base sm:text-lg md:text-xl font-bold text-white mb-4 leading-tight uppercase text-center">
        ...
        <div className="relative bg-[#131313]">
          ...
          >
            <div className="container mx-auto px-2 md:px-8 lg:px-12">
              <h2 className="text-2xl font-bold text-white mb-24 text-center transform transition-all duration-1000">
                About Me
              </h2>
              <div className="flex flex-col md:flex-row items-start justify-center gap-16 max-w-7xl mx-auto">
                {/* Left Column - Photo */}
                <div className="w-full md:w-1/2 max-w-[400px] transform transition-all duration-1000">
                ...
                <div className="w-full md:w-1/2 max-w-xl transform transition-all duration-1000">
                  <Parallax translateY={[15, -15]} opacity={[0.8, 1]} speed={-3}>
                    ...
                    <p className="text-yellow-300 mb-8 text-sm leading-relaxed border-l-2 border-yellow-400/50 pl-4">
                    ...
                    <a
                      ...
                      className="inline-flex text-sm items-center gap-2 bg-yellow-400/10 hover:bg-yellow-400/20 text-yellow-500 hover:text-white py-2 px-8 rounded-lg transition-all duration-300"
                    >
                      <svg 
                        className="w-5 h-5" 
                        fill="none" 
          ...
          <section id="contact" 
            className={`h-[450px] w-full bg-[#131313] flex items-center justify-center py-16 relative overflow-hidden
              transform transition-all duration-1000 ease-out
              ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}
          ...
          >
            ...
            <div className="container mx-auto px-4 md:px-16 lg:px-24 relative z-10">
              <Parallax translateY={[-25, 25]} opacity={[0.5, 1]} speed={5}>
                <h2 className="text-xl font-light text-white mb-8 text-center">Get in Touch</h2>
              </Parallax>
          ...
          {/* Footer */}
          <footer className="w-full bg-[#131313] py-8 px-4">
