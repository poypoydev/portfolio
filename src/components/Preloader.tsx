...
const Preloader: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#131313] overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center">
          ...
          <div className="relative w-20 h-20">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-24 h-24">
                <div className="absolute w-2 h-2 bg-yellow-400 rounded-full animate-orbit1" style={{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}></div>
                <div className="absolute w-2 h-2 bg-yellow-400 rounded-full animate-orbit2 delay-150" style={{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}></div>
                <div className="absolute w-2 h-2 bg-yellow-400 rounded-full animate-orbit3 delay-300" style={{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center">
          <span className="text-2xl font-bold text-yellow-400 font-mono tracking-wider">
            {percentage}%
          </span>
          <div className="mt-4 w-48 h-1 bg-yellow-400/20 rounded-full overflow-hidden">
            <div 
